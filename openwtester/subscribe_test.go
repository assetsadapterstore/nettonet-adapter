...
func TestSubscribeAddress_NTN(t *testing.T) {

	var (
		endRunning = make(chan bool, 1)
		symbol     = "NTN"
		addrs      = map[string]string{
			"0x58fb97021ff7ec9fa8c5c88340236dff9f261b61": "sender",
			"0x86b887251fd50c1a8777c02857f430ce112dced8": "receiver",
		}
	)
	...
	//scanner.SetRescanBlockHeight(12600)
